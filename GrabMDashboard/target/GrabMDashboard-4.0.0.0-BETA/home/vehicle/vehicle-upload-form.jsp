...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box-header with-border">
            <h3 class="box-title text-uppercase txt-light-gray txt-light-weight2">Upload Vehicle list</h3>
        </div>

        <form role="form" method="POST" id="upload_vehicle_list_form">
            ...
            <div class="form-group margin-bottom-none">
                <div class="col-md-6 pt-10">
                    <div class="file-upload-theme">
                        ...
                        <input id="vehicle_list_upload_file" name="vehicle_list_upload_file" type="file"  class="file-loading">
                        <div id="errorBlockVehicle" class="help-block"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-6 margin-bottom-none pt-10">
                ...
                <span> <button style="min-width: 150px; margin-bottom: 5px;" type="button" class="btn-override btn-theme" id="upload_vehicle_list_form_cancel">Reset</button></span>
            </div>

            <div class="col-xs-12 margin-bottom-none pt-10">
                <div class="box">
                    <div class="">
                        <h4 class="box-title text-uppercase txt-light-gray txt-light-weight2">Vehicle List Status</h4>
                    </div>
                    ...
                    <div id="crew-list-status-wrapper">
                        <div class="row">
                            <div class="col-md-6 margin-bottom pt-10"> 
                                ...
                                <span class="text-uppercase txt-light-gray txt-light-weight2">Vehicles are ready to upload</span>
            ...
            <div class="col-xs-12 margin-bottom-none pt-10">
                <span><button style="min-width: 200px; margin-bottom: 5px;" type="submit" class="btn-override btn-theme" id="upload_vehicle_list_form_submit">SUBMIT</button></span>
            </div>
            <!-- /.box-body -->
